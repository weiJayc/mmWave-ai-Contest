...
from KKT_Module.SettingProcess.ExcelParsing import KsocExcelParser, ParamDictGenerator
...
from KKT_Module.KKTModuleLogger import get_logger
import os

log = get_logger('Set_Proc')
...
class ProcessComposite(ProcessComponent):
    def __init__(self):
        ...
        self.processes_dict = {}
        self.process = ''
        self.end_callback_func:Optional[Callable]=None
    ...
    def startUp(self, config:SettingConfigs):
        ...
        #     print(error)
        #     return
        if self.end_callback_func:
            self.end_callback_func()
...
class SettingProc(ProcessComposite):
    ...
    def __cleanupFunction(self):
        log.info('KsocSettingProc cleanupFunction')
        self.__closeDevice()
...
class GenProcessScript(ProcessComponent):
    ...
    def startUp(self, config=None):
        ...
        PLG = ProcessListGenerator(chip_ID=config.Chip_ID)
