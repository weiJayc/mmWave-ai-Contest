...
# -------------------------------
TRAINING_DATA_DIR = r"D:\Programming\mmWave\gesture-IR-controller\data\processed_data\train_dataset.npz"
VAL_DATA_DIR = r"D:\Programming\mmWave\gesture-IR-controller\data\processed_data\val_dataset.npz"
WINDOW_SIZE = 30
STEP_SIZE = 1
BATCH_SIZE = 32
EPOCHS = 50
LEARNING_RATE = 1e-4
NUM_CLASSES = 6  # Six classes: background, doubleTap, pull, push, waveLeft, waveRight
...
gesture_types = ['background', 'doubleTap', 'pull', 'push', 'waveLeft', 'waveRight']
...
def load_data(data_path):
    ...
    Returns:
        ...
        y (np.array): Array of shape (num_samples, NUM_CLASSES) containing soft labels.
    """
    ...
    ground_truths = data['ground_truths']  # (frames, NUM_CLASSES)
    ...
    for start in range(0, num_frames - WINDOW_SIZE + 1, STEP_SIZE):
        ...
        label_soft = ground_truths[mid]              # Shape: (NUM_CLASSES,)
