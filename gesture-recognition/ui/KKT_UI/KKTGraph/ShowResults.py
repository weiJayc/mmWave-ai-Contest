...
from KKT_UI.QTWidget.qt_obj import InputThreshold
...
class DrawingResult_GS(QtWidgets.QWidget):
    ...
    def axis_range(self, value: list):
        if value is not None:
            ...
            self._stemplot.setAxisRange(value[0], value[1])
    ...
    def __setupUI(self):
        ...
        self._stemplot = StemPlotWidget(title=self._drawingTitle)
